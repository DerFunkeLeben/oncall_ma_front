...
const getCurrentAudiences = (state: IState): IStoreAudiences[StoreKeys.currentAudience] =>
...
export { getAudiences, getCurrentAudiences, getAllAudiences, getTitleMatch, getAudiencesById }
